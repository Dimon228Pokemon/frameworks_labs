...
- **R²** — доля объяснённой дисперсии; интерпретируемость результата

**Вывод:** основными метриками считаются MAE и R², как наиболее интерпретируемые для бизнеса
...
- Подбор гиперпараметров улучшит MAE и R²
