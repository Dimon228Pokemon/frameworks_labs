...
**Вывод:** дерево регрессии также показывает признаки переобучения. Ошибка RMSE значительно растёт, и хотя R^2 остаётся высоким, модель очевидно обладает недостаточной обобщающей способностью из-за огромной глубины.
...
**Вывод:** улучшенная версия значительно уменьшила RMSE и увеличила R^2. Модель стала менее переобученной, давая более адекватные прогнозы.
...
- **Регрессия:** заметное снижение RMSE и рост R^2
