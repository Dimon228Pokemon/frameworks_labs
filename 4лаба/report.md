...
**Вывод:** базовая модель даёт хорошее качество предсказаний, R² высокий, ошибки умеренные.
...
- sklearn даёт R² = 0.925, самописная ≈0.69 - плюс 25% по объяснённой дисперсии
